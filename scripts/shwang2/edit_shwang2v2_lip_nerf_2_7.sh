...
#TEXT_PROMPTS=("happy face" "sad face" "surprised face" "scaed face" "angry face"  "crying face" "sleeping face")
TEXT_PROMPTS=("sad face")
REFERENCE_WARP_ID=3
for i in "${!TEXT_PROMPTS[@]}"; do
    ...
    python edit_nerf.py \
        ...
        --gin_configs configs/edit_nerf_test_local_lip_shwang2.gin \
