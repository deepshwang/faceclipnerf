...
gin.config.external_configurable(nn.Dense, module='flax.nn')
...
class ExperimentConfig:
  ...
  # Specific warp id for editing
  edit_warp_id: int = 5
  # Specifig appearance id for editing
  edit_appearance_id: int = 5
...
class TrainConfig:
  ...
  # Whether to regularize lipschitz mlp constants (Should be true only if you're using lipmlp)
  use_lipschitz_loss: bool = False 
  # The weight for the lipschitz regularization loss.
  lipschitz_loss_weight: float = 0.0000001
  target_text_prompt: str = ''
  reference_text_prompt: str = ''
