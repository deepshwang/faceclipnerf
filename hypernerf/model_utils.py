...
def volumetric_rendering(rgb,
  ...
  if hyper_masks is not None:
    mask = (weights[..., None] * hyper_masks).sum(axis=-2)
    out['mask'] = mask
  return out
...
def inject_params(ref_param: Dict, target_param: Dict, reference_warp_id: int = None, reference_hyper_id: list = None):
  ...
  if reference_hyper_id is not None: 
    # Initialize hyper embedding with anchor embedding
    target_param['model']['hyper_embed']['embed']['embedding'] = ref_param['model']['warp_embed']['embed']['embedding'][reference_hyper_id]
  #else:
  #  target_param['model']['hyper_embed']['embed']['embedeing'] = init_embed[jnp.newaxis, ...]
...
def inject_params_nerf(ref_param: Dict, target_param: Dict, reference_warp_id: int = None, reference_hyper_id: list = None):
  ...
  if reference_warp_id is not None:
    init_embed = ref_param['model']['warp_embed']['embed']['embedding'][reference_warp_id]
    target_param['model']['warp_embed']['embed']['embedding'] = init_embed[jnp.newaxis, ...]
    target_param['model']['hyper_embed']['embed']['embedding'] = init_embed[jnp.newaxis, ...]
  target_param = flax.core.frozen_dict.freeze(target_param)
  return target_param