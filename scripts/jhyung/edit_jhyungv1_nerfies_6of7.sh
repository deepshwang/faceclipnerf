...
REF_EXPERIMENT_PATH=/home/nas4_user/sungwonhwang/logs/hypernerf/jhyungv1_nerfies

EXPERIMENT_PATH=/home/nas4_user/sungwonhwang/logs/hypernerf/edit_jhyungv1_nerfies
...
for i in "${!TEXT_PROMPTS[@]}"; do
    ...
    python edit_nerfies.py \
        ...
        --gin_configs configs/edit_nerfies_test_local_lip_jhyung.gin \
